...
class FormularioBusqueda extends Component {
    ...
    constructor(props) {
        ...
        this.handleSubmit = this
            .handleSubmit
            .bind(this);
        this.handleUsuario = this
            .handleUsuario
            .bind(this);
        this.handleIncluirMiembro = this
            .handleIncluirMiembro
            .bind(this);
    ...
    handleSubmit(ev) {
        ...
        this
            .props
            .onBuscar({usuario: this.state.usuario, incluirMiembro: this.state.incluirMiembro, sort: this.state.sort});
    }
        ...
        return (
            <li className="resultado">
                <h3>
                    ...
                    {resultado.private && <span className="resultado-privado">Privado</span>}
                </h3>
...
class App extends Component {
    ...
    constructor() {
        ...
        this.cambiarCriterioBusqueda = this
            .cambiarCriterioBusqueda
            .bind(this);
    }
            ...
            .then(function (response) {
                if (response.ok) {
                    response
                        .json()
                        .then(function (body) {
                            this.setState({resultados: body, totalResult: body.length});
                        }.bind(this));
                } else {
                    this.setState({resultados: [], totalResult: '0'});
                }
            }.bind(this));
    }
